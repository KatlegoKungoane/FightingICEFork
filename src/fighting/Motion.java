...
public class Motion {
    ...
    public int getFrameNumber(boolean useMinFrame) {
        if (useMinFrame && this.actionName.equals(enumerate.Action.NEUTRAL.name())) {
            return 60;
        }
        return this.frameNumber;
    }
     ...
     *                        the value of the damage to the unguarding opponent
     *                        when it is
     *                        hit by this motion
     */
     ...
     *                          the value of the damage to the guarding opponent
     *                          when it is
     *                          hit by this motion
     */
     ...
     *                             the value of the energy added to the character
     *                             when it uses
     *                             this motion.
     */
     ...
     *                           the value of the energy added to the character when
     *                           this
     ...
     *                         the value of the energy given to the opponent when it
     *                         is hit
     *                         by this motion
     */
     ...
     *
     * @param attackImpactX
     *                      the change in the horizontal speed of the opponent when
     *                      it is
     *                      hit by this motion
     */
     ...
     *
     * @param attackImpactY
     *                      the change in the vertical speed of the opponent when it
     *                      is
     *                      hit by this motion
     */
     ...
     *                             the number of frames that the guarding opponent
     *                             needs to
     *                             resume to its normal status after being hit by
     *                             this motion
     */
     ...
     *                       the flag whether this motion can push down the opponent
     *                       when
     ...
     *                        the value to assign to the {@link #cancelAbleFrame}
     *                        setting
     */
